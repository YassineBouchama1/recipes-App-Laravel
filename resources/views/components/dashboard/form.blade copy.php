<section class=" bg-white rounded-md p-4">
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                <label class="dark:text-white text-black-200" for="username">Username</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="emailAddress">Email Address</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="password">Password</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Password Confirmation</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Color</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Select</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Range</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Date</label>
            ...
            <div>
                <label class="dark:text-white text-black-200" for="passwordConfirmation">Text Area</label>
